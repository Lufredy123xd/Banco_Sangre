...
return [
    ...
    | modificar estos mensajes según sea necesario.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se utilizan para intercambiar los marcadores de posición
    | de atributos por algo más amigable para el usuario, como "Correo Electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a hacer los mensajes un poco
    | más claros.
    |
    */
    ...
    'custom' => [
        'cedula' => [
            'unique' => 'La cédula ingresada ya está registrada.',
        ],
    ],
];