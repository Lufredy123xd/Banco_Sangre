                ...
                <form action="{{ url('/usuario') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control" name="fecha_nacimiento"
                                        ...
                                        title="Fecha no puede ser posterior a hoy">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="user_name" id="txt__nombre_usuario"
                                        required placeholder="Nombre de usuario" maxlength="50" pattern="[A-Za-z0-9_]+"
