        ...
        <form action="{{ url('/usuario') }}" method="post" class="registrar__formulario">
            ...
            <div class="contenedor__datos__sangineos">
                ...
                <div>
                    ...
                    <input class="input__div" type="text" name="user_name" id="txt__nombre_usuario" required
                ...
                <div>
                    ...
                    <input class="input__div" type="password" name="password" id="txt__password" required minlength="8"
