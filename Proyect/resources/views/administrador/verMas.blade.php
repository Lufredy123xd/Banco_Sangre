    ...
    <form action="{{ url('/administrador/' . $usuario->id) }}" method="post" class="registrar__formulario">
        ...
        <div class="contenedor__nombre__completo">
            <div>
                ...
                <input disabled class="input__div" type="text" name="nombre" id="txt__nombre"
            ...
            <div>
                ...
                <input disabled class="input__div" type="text" name="apellido" id="txt__apellido"
        ...
        <input disabled class="input__div" type="text" name="cedula" id="txt__cedula"
        ...
        <select disabled class="input__div" name="tipo_usuario" id="txt__tipo_usuario" required>
        ...
        <select disabled class="input__div" name="curso" id="txt__curso">
        ...
        <div class="contenedor__datos__sangineos">
            <div>
                ...
                <input disabled class="input__div" type="date" name="fecha_nacimiento" id="txt__fecha_nacimiento"
            ...
            <div>
                ...
                <input disabled class="input__div" type="text" name="nombre_usuario" id="txt__nombre_usuario"
            ...
            <div>
                ...
                <input disabled class="input__div" type="password" name="password" id="txt__password"
            ...
            <div>
                ...
                <select disabled class="input__div" name="estado" id="txt__estado" required>
