                ...
                <form action="{{ url('/donacion/' . $donacion->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select id="anticuerpos_irregulares" name="anticuerpos_irregulares" class="form-select"
                                        required>
                    ...
                    @php
                        ...
                        if ($return === 'gestionarDonante') {
                            $cancelUrl = route('gestionarDonante', ['id' => $donacion->id_donante]);
                        } else {
                            $cancelUrl = route('donacion.index');
                        }
                    @endphp
